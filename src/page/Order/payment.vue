      ...
      <div slot="content">
        ...
        <div class="pay-type">
          ...
          <div class="pay-item">
            ...
            <!-- 改成 click="payType=2" 这样就表示支付宝暂时无法使用 -->
            <div :class="{ active: payType == 1 }" @click="payType = 2"><img src="/static/images/alipay@2x.png" alt="" /></div>
            <div :class="{ active: payType == 2 }" @click="payType = 2"><img src="/static/images/weixinpay@2x.png" alt="" /></div>
          </div>
          <div class="qr-center"><vue-qr :logoSrc="logoUrl" :text="codeUrl" :size="256"></vue-qr></div>
        </div>
